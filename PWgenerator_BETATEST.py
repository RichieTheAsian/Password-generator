...
def main():
    ...
    feedback = input("Please share your thoughts on the password generated: ")
    satisfaction = input("On a scale of 1-5, how satisfied are you with the password generated? ")

    print("Your feedback is highly appreciated! Thank you.")
